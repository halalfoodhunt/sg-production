ActiveAdmin.register OnlineRetail do
  ...
  scoped_collection_action :scoped_collection_update, form: -> do
    { expiry_date: 'datepicker',
      ...
      product_qualifying_type_id: ProductQualifyingType.all.map { |product_qualifying_type| [product_qualifying_type.name, product_qualifying_type.id] }, :prompt => "Select One",
      draft: [['Yes', 't'], ['No', 'f']],
      verified: [['Yes', 't'], ['No', 'f']]
    }
  end
