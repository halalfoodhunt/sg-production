class OnlineRetail < ActiveRecord::Base
  extend FriendlyId
  ...
  has_many :menus, dependent: :destroy, inverse_of: :online_retail
  accepts_nested_attributes_for :menus, reject_if: :all_blank, allow_destroy: true
  
  has_many :verifying_documents, dependent: :destroy, inverse_of: :online_retail
