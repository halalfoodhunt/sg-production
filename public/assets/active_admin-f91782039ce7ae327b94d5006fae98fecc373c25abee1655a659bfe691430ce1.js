...
(function() {
  $(document).ready(function() {
    return $(document).on('click', '.scoped_collection_action_button', function(e) {
      var fields;
      e.preventDefault();
      fields = JSON.parse($(this).attr('data'));
      return ActiveAdmin.dialogMassFieldsUpdate(fields['confirm'], fields['inputs'], (function(_this) {
        return function(inputs) {
          var form_data, url;
